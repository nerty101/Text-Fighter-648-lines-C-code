...
{
printf("\nYour attack succeeded, enemy counter failed!\n");
enemyhp = (enemyhp - 2);
...
if (dice2 > dice1)
{
printf("\nYour attack failed, enemy counter succeeded!\n");
printf("Your HP at %d\n", --playerhp);
consecvic = 0;
consecvic2 = 0;
normag = 0;
...
if (dice1 == dice2)
{
printf("\nYour attack failed, enemy counter failed\n");
consecvic = 0;
consecvic2 = 0;
normag = 0;
}
...
{
playerhp = (playerhp + 3);
printf("\nYour magic heal succeeded, enemy counter failed!\n");
printf("Player HP at %d\n", playerhp);
}
...
{
playerhp = (playerhp - 2);
printf("\nYour magic heal failed, enemy counter succeeded!\n");
printf("Player HP at %d\n", playerhp);
consecvic2 = 0;
spmag = 0;
spmag2 = 0;
...
if (dice3 == dice4)
{
printf("\nYour magic heal failed, enemy counter failed\n");
consecvic2 = 0;
spmag = 0;
spmag2 = 0;
magsp = 0;
...
{
printf("\nYour special attack succeeded, enemy counter failed!\n");
...
{
printf("\nYour Magic Special Attack succeeded, enemy counter failed!\n");
...
{
playerhp = (playerhp - 2);
printf("\nYour special attack failed, enemy counter succeeded!\n");
printf("Your HP at %d\n", playerhp);
consecvic2 = 0;
magsp = 0;
magsp2 = 0;
...
if (dice5 == dice6)
{
printf("\nYour special attack failed, enemy counter failed\n");
consecvic2 = 0;
magsp = 0;
magsp2 = 0;
magsp3 = 0;

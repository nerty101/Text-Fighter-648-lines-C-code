...
int diflev = 0, posdef = 0, posmag = 0, posbon = 0, bonchn = 0, bonchn2 = 0, cpusp = 0;
int  ans6 = 1;
time_t t;
...
{
{
dice5 = (rand() % 28 + diflev - 1);// 14 then was 17 THEN 18 then 19 NOW 20 OR 21??? 22 23 24 26 27 28
if (diflev > 36)
dice5 = (rand() % 62) + 1;
...
{
diceE = (rand() % 27 + diflev - 2) + 1;//maybe 28 ????????????? was 24
}
if ((diflev > 35) && ((choice == 'm') || (choice == 's')) && (choice != 'n'))
diceE = (rand() % 60) + 1;
else
{
if ((choice == 'n') && (choice != 'm') && (choice != 's'))//for this diceE is 30 not 28 need to encourage sp for game maybe
diceE = (rand() % 31 + diflev - 2) + 1;//maybe 32 0r 34??????????????
if ((diflev > 35) && (choice == 'n') && (choice != 'm') && (choice != 's'))//for this diceE is 30 not 28 need to encourage sp for game maybe
diceE = (rand() % 64) + 1;//maybe 32 0r 34???
}
...
diceF = (rand() % 36 + diflev - 2) + 1; //was 34 36
if ((diflev > 35) && ((choice == 's') || (choice == 'n')) && (choice != 'm'))
diceF = (rand() % 69) + 1; //was 34
else
if ((choice == 'm') && (choice != 's') && (choice != 'n'))
diceF = (rand() % 39 + diflev - 2) + 1;
if ((diflev > 35) && (choice == 'm') && (choice != 's') && (choice != 'n'))
diceF = (rand() % 72) + 1;
}
...
diceC = (rand() % 29 + diflev - 2) + 1;//was 26 28 -3
if ((diflev > 35) && ((choice == 'm') || (choice == 'n')) && (choice != 's'))
diceC = (rand() % 62) + 1;
else
if ((choice == 's') && (choice != 'm') && (choice != 'n'))
diceC = (rand() % 35 + diflev - 2) + 1;
if ((diflev > 35) && (choice == 's') && (choice != 'm') && (choice != 'n'))
diceC = (rand() % 68) + 1;
}//added

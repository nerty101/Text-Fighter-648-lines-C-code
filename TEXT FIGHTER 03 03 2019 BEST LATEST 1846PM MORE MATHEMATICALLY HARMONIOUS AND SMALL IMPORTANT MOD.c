...
diceF = (rand() % 46 + diflev) + 1; //was 34 36 66 46 50
else
if ((choice == 'm') && (choice != 's') && (choice != 'n'))
diceF = (rand() % 56 + diflev) + 1; //82 , 64 + 10 TO 20 56 60
}
...
if (playerhp > 0)
printf("\n");
if ((enspcomb3 == 1) && ((diceE > 16) && (diceB >= 4) && (diceB <= 5)) && ((diceF > 32) && (diceB >= 5) && (diceB <= 6)) && ((diceC > 48) && (diceB == 5)))
{
...
if (enemspcombC != 1)
{
if ((enspcomb1 == 1) && ((diceE > 16) && (diceB >= 4) && (diceB <= 5)) && ((diceF > 32) && (diceB >= 5) && (diceB <= 6)))
{
...
if ((enspcomb2 == 1) && ((diceE > 16) && (diceB >= 4) && (diceB <= 5)) && ((diceC > 48) && (diceB == 5)))
{

...
{
{
dice5 = (rand() % 28 + diflev - 1);// 14 then was 17 THEN 18 then 19 NOW 20 OR 21??? 22 23 24 26 27 28 -1
...
diceF = (rand() % 52 + diflev) + 1; //was 34 36 66 46 50
else
if ((choice == 'm') && (choice != 's') && (choice != 'n'))
diceF = (rand() % 62 + diflev) + 1; //82 , 64 + 10 TO 20 56 60
}
if  ((diceF > 32) && (diceB == 5) && (playerhp > 0))
{
playerhp = (playerhp - 6);
...
diceC = (rand() % 76 + diflev) + 1;//was 26 28 29, -2 down  so + 20 - 30 so 50 + diflev - 30// 126, 68
else
if ((choice == 's') && (choice != 'm') && (choice != 'n'))
diceC = (rand() % 90 + diflev) + 1; //was 35 144 86
}//added
if  ((diceC > 50) && (diceB == 5) && (playerhp > 0))
{
...
if (playerhp > 0)
printf("\n");
if ((enspcomb3 == 1) && ((diceE > 16) && (diceB >= 4) && (diceB <= 5)) && ((diceF > 32) && (diceB == 5)) && ((diceC > 50) && (diceB == 5)))
{
...
if (enemspcombC != 1)
{
if ((enspcomb1 == 1) && ((diceE > 16) && (diceB >= 4) && (diceB <= 5)) && ((diceF > 32) && (diceB == 5)))
{
...
if ((enspcomb2 == 1) && ((diceE > 16) && (diceB >= 4) && (diceB <= 5)) && ((diceC > 50) && (diceB == 5)))
{
...
if ((enspcomb2 == 1) && ((diceC > 50) && (diceB == 5)) && ((diceF > 32) && (diceB == 5)))
{

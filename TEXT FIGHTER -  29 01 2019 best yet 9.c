...
int diflev = 0, posdef = 0, posmag = 0, bonchn = 0, posbon = 0;
int  ans6 = 1;
time_t t;
...
posmag = 0;
posbon = 0;
if ((consecvic > 2) && (enemyhp > 0)) //&& (normag < 1) && (normag > 0))
{
enemyhp = (enemyhp - 1);
...
if (bonchn > 2)
{
printf("That's an effective Bonus Attack strategy!\n");
}
break;
}
if (dice2 > dice1)
...
if (ctr < 2)
{
printf("You win in the first round!\n");
printf("\nVery impressive!\n\n");
}
else
{

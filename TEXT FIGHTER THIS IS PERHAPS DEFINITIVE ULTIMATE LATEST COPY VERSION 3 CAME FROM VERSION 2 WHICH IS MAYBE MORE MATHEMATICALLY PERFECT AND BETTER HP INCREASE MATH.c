...
{//added
diceF = (rand() % 34) + 1;//100 then 300 test 17 and code change is 100? was 30 was 36 34 32
}
...
{
printf("THE ENEMY SUPER SPECIAL COMBO!\n\n");
if (playerhp < 1)
{
printf("THAT'S AN IMPRESSIVE ENEMY COMBO FINISH!\n");
}
spatt = 0;
supspatt = 0;
enspcomb1 = 0;

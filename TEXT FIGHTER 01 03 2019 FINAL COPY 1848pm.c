...
{
diceE = (rand() % 26 + diflev - 1) + 1;//maybe 28 ????????????? was 24
}
...
diceF = (rand() % 34 + diflev - 2) + 1; //was 34 36
if ((diflev > 35) && ((choice == 's') || (choice == 'n')) && (choice != 'm'))
diceF = (rand() % 67) + 1; //was 34
else
if ((choice == 'm') && (choice != 's') && (choice != 'n'))
diceF = (rand() % 38 + diflev - 1) + 1;
if ((diflev > 35) && (choice == 'm') && (choice != 's') && (choice != 'n'))
diceF = (rand() % 76) + 1;
}

...
diceF = (rand() % 47 + diflev) + 1; //was 34 36 66 46 50
else
if ((choice == 'm') && (choice != 's') && (choice != 'n'))
diceF = (rand() % 57 + diflev) + 1; //82 , 64 + 10 TO 20 56 60
}
...
diceC = (rand() % 71 + diflev) + 1;//was 26 28 29, -2 down  so + 20 - 30 so 50 + diflev - 30// 126, 68
else
if ((choice == 's') && (choice != 'm') && (choice != 'n'))
diceC = (rand() % 85 + diflev) + 1; //was 35 144 86
}//added
